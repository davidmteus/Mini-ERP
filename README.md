...
Usuários
Gerenciamento dos usuários que possuem acesso ao sistema.

Vendas
Cadastro e gerenciamento das vendas realizadas.
...
Acesse o sistema pelo navegador através de http://localhost/mini_erp/.
Banco de Dados
